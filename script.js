// Initial Data
let tasks = [
    { id: 1, name: 'Finish Math Homework', dueDate: '2025-12-10', status: 'pending', subject: 'Math' },
    { id: 2, name: 'Revise for IPT exam', dueDate: '2025-12-12', status: 'done', subject: 'IPT' },
    { id: 3, name: 'SA1/11 Lab Report', dueDate: '2025-12-16', status: 'pending', subject: 'SA1/11' },
    { id: 4, name: 'Submit English Essay', dueDate: '2025-12-18', status: 'overdue', subject: 'English' }
];

let notes = [
    { id: 1, title: 'Lecture Note Title', url: 'www.lecturelink.com', date: '2023-11-02' },
    { id: 2, title: 'Chemistry Procedures', url: 'www.chemistrylab.com', date: '2023-11-01' }
];

let resources = [
    { id: 1, title: 'Laboratory Online', url: 'www.labonline.com', date: '2023-11-02' },
    { id: 2, title: 'Citation Guide', url: 'www.citationguide.com', date: '2025-12-14' }
];
...
function handleAddTask(e) {
    ...
    const due = new Date(dueDate);
    const status = existingTask?.status === 'done' ? 'done' : (due < getStartOfToday() ? 'overdue' : 'pending');
...
function handleAddResource(e) {
    ...
    if (editingResourceId) {
        resources = resources.map(r => (r.id === editingResourceId ? resourceData : r));
    } else {
