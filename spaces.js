...
let files = [
    ...
    { id: 2, name: 'Assignment 1.docx', type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', size: 1500000 },
    { id: 3, name: 'Presentation.pptx', type: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', size: 3200000 },
    { id: 4, name: 'Formula Sheet.jpg', type: 'image/jpeg', size: 800000 },
    { id: 5, name: 'Study Guide.pdf', type: 'application/pdf', size: 1800000 }
];

let notes = [
    { id: 1, title: 'Derivatives Review', content: 'Key concepts for derivatives:\n\n1. Power Rule\n2. Product Rule\n3. Chain Rule\n\nPractice problems on page 45-50.' },
    { id: 2, title: 'Integration Techniques', content: 'Methods for integration:\n- Substitution\n- Integration by parts\n- Partial fractions' },
    { id: 3, title: 'Limits and Continuity', content: 'Important limit rules and continuity definitions.' }
];

let links = [
    { id: 1, title: 'Khan Academy - Calculus', url: 'www.khanacademy.org/math/calculus', createdAt: 'Jan 15, 2026' },
    { id: 2, title: 'Wolfram Alpha', url: 'www.wolframalpha.com', createdAt: 'Jan 10, 2026' },
    { id: 3, title: 'MIT OpenCourseWare', url: 'ocw.mit.edu/mathematics', createdAt: 'Jan 5, 2026' }
];
...
function previewFile(id) {
    ...
    document.getElementById('previewSize').textContent = `Size: ${formatFileSize(file.size)}`;
...
function openNoteModal() {
    ...
    const spaceName = document.getElementById('workspaceTitle')?.textContent || 'Workspace';
    document.getElementById('noteModalTitle').textContent = `Add Note to ${spaceName}`;
    document.getElementById('noteModal').classList.add('active');
}
...
function openLinkModal() {
    ...
    const spaceName = document.getElementById('workspaceTitle')?.textContent || 'Workspace';
    document.getElementById('linkModalTitle').textContent = `Add Link to ${spaceName}`;
    document.getElementById('linkModal').classList.add('active');
}
