...
let pages = [
    {
        ...
        content: 'Physics is the natural science that studies matter, energy, and motion. It seeks to understand how the universe works at the most fundamental level.',
        icon: '📚',
        date: '2025-12-10',
    ...
    },
    {
        ...
        content: 'Today\'s lab experiment involved testing the pH levels of various solutions. We used litmus paper and pH meters to determine acidity and basicity.',
        icon: '🧪',
        date: '2025-12-08',
...
function closePageEditor() {
    if (editingPageId === null && (pageTitle.textContent.trim() !== '' || pageContent.innerHTML.trim() !== '')) {
...
function savePage() {
    ...
    const pageData = {
        ...
        icon: icon || '📄',
        date: dateStr,
        createdAt: editingPageId ? (pages.find(p => p.id === editingPageId)?.createdAt || today.getTime()) : today.getTime()
    };
